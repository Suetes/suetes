...
def plot_grid_comparison():
    # 1. Setup the Suetes Base Grid
    nx, ny, nz = 300, 300, 40
    dx, dy, dz = 2000.0, 2000.0, 500.0
    lat_c, lon_c = 45.0, 5.0
    sponge_depth = 15

    print("1. Initializing Suetes Geometry...")
    base_grid = RegionalGrid3D(nx, ny, nz, dx, dy, dz, lat_c, lon_c)

    # 2. Process and blend the topography
    print("2. Interpolating and Blending Topography...")
    ...
    # 3. Evaluate the topography on the Suetes 2D mesh
    ...
    # Use our new h_func to get the height at every cell
