...
def run_gradient_field_comparison(
    data_dir: Path, figure_dir: Path, *, render: bool = True
):
    print("\n==========================================================================")
    ...
    dataset = xr.Dataset(
        data_vars={
            "adjoint_gradient": (
                ("core", "x", "z"), np.stack([g_se_2d, g_sisl_2d])
            ),
        },
        coords={
    ...
    artifact = save_plot_dataset(
        ...
        experiment="core_adjoint_analysis",
    )
...
if __name__ == "__main__":
    ...
    if args.output_dir is None:
        layout = ArtifactLayout(
            kind="experiments", case="core_adjoint_analysis",
    ...
    run_gradient_field_comparison(
        data_dir, figure_dir, render=not args.no_render
    )
