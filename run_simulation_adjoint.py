...
def main():
    ...
    topo_proc = TopographyProcessor(era5_sl_path=sl_file, gebco_path="suetes/data/gebco_data.nc")
    ...
    visualizer.plot_adjoint_overlay(
        ...
        save_path=os.path.join(output_dir, f"{ACTIVE_DOMAIN}_adjoint_impact_pct_{sim_hours}h.png")
    )
    ...
    visualizer.plot_2d_field(
        ...
        save_path=os.path.join(output_dir, f"{ACTIVE_DOMAIN}_adjoint_kinetic_sens_{sim_hours}h.png")
    )
    ...
    visualizer.plot_level_strip(
        ...
        save_path=os.path.join(output_dir, f"{ACTIVE_DOMAIN}_adjoint_levels_w_{sim_hours}h.png")
    )
    ...
    visualizer.plot_cross_section(
        ...
        save_path=os.path.join(output_dir, f"{ACTIVE_DOMAIN}_adjoint_xz_th_v_{sim_hours}h.png")
    )
    
    visualizer.plot_cross_section(
        grid, sensitivities, 'w', y_idx=mid_y, 
        sponge_depth=sponge_depth, overlay_isentropes=False, 
        save_path=os.path.join(output_dir, f"{ACTIVE_DOMAIN}_adjoint_xz_w_{sim_hours}h.png")
    )
