...
if __name__ == "__main__":
    ...
    ax4.plot(t_sisl_fair, enst_sisl_fair, '^--', color='#2ca02c', label=f'SISL Equal-Timestep ($\Delta t = 1.0$s, -{enst_diff_fair:.1f}%)', linewidth=2.5, markersize=7)
    ax4.plot(t_sisl_op, enst_sisl_op, 's-', color='#ff7f0e', label=f'SISL Operational ($\Delta t = 10.0$s, -{enst_diff_op:.1f}%)', linewidth=2.5, markersize=7)
