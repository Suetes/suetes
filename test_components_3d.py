...
from suetes.regional3d.steppers import SemiLagrangianAdvector3D, SISLStepper3D, SemiImplicitSolver3D
...
# Relaxed the tolerance to 1e-3 to account for float32 precision limits
...
# Also, float64 vs float32 warnings can be safely ignored, but to suppress them,
# you can use float32 in your meshgrid creation if you prefer.
...
# You will need to make sure line 91 in your steppers.py is updated to use dz_m_full
# instead of self.physics.grid.dz for this fixer to actually work over topography!
...
# Instantiate the real physics engine
...
print("\nAll Dynamics tests completed successfully!")
